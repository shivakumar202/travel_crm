...
const countries = [
  ...
  },
  {
    ...
    name: 'Belgium',
    dialCode: '+32',
    flag: '/media/flags/belgium.svg',
  },
  {
    code: 'CH',
    name: 'Switzerland',
    dialCode: '+41',
    flag: '/media/flags/switzerland.svg',
  },
  {
    code: 'AT',
    name: 'Austria',
    dialCode: '+43',
    flag: '/media/flags/austria.svg',
  },
  {
    code: 'SE',
    name: 'Sweden',
  ...
  },
  {
    ...
    name: 'Norway',
    dialCode: '+47',
    flag: '/media/flags/norway.svg',
  },
  {
    code: 'DK',
    name: 'Denmark',
    dialCode: '+45',
    flag: '/media/flags/denmark.svg',
  },
  {
    code: 'FI',
    name: 'Finland',
    dialCode: '+358',
    flag: '/media/flags/finland.svg',
  },
  {
    code: 'PL',
    name: 'Poland',
    dialCode: '+48',
    flag: '/media/flags/poland.svg',
  },
  {
    code: 'CZ',
    name: 'Czech Republic',
  ...
  },
  {
    ...
    name: 'India',
    dialCode: '+91',
    flag: '/media/flags/india.svg',
  },
  {
    code: 'SG',
    name: 'Singapore',
    dialCode: '+65',
    flag: '/media/flags/singapore.svg',
  },
  {
    code: 'HK',
    name: 'Hong Kong',
    dialCode: '+852',
    flag: '/media/flags/hong-kong.svg',
  },
  {
    code: 'TW',
    name: 'Taiwan',
    dialCode: '+886',
    flag: '/media/flags/taiwan.svg',
  },
  {
    code: 'MY',
    name: 'Malaysia',
    dialCode: '+60',
    flag: '/media/flags/malaysia.svg',
  },
  {
    code: 'TH',
    name: 'Thailand',
  ...
  },
  {
    ...
    name: 'Philippines',
    dialCode: '+63',
    flag: '/media/flags/philippines.svg',
  },
  {
    code: 'ID',
    name: 'Indonesia',
    dialCode: '+62',
    flag: '/media/flags/indonesia.svg',
  },
  {
    code: 'VN',
    name: 'Vietnam',
  ...
  },
  {
    ...
    name: 'Argentina',
    dialCode: '+54',
    flag: '/media/flags/argentina.svg',
  },
  {
    code: 'CL',
    name: 'Chile',
    dialCode: '+56',
    flag: '/media/flags/chile.svg',
  },
  {
    code: 'CO',
    name: 'Colombia',
    dialCode: '+57',
    flag: '/media/flags/colombia.svg',
  },
  { code: 'PE', name: 'Peru', dialCode: '+51', flag: '/media/flags/peru.svg' },
  {
    ...
    name: 'South Africa',
    dialCode: '+27',
    flag: '/media/flags/south-africa.svg',
  },
  {
    code: 'EG',
    name: 'Egypt',
  ...
  },
  {
    ...
    name: 'Kenya',
    dialCode: '+254',
    flag: '/media/flags/kenya.svg',
  },
  {
    code: 'IL',
    name: 'Israel',
    dialCode: '+972',
    flag: '/media/flags/israel.svg',
  },
  {
    code: 'AE',
...
function PhoneNumberInput({ value, onChange }) {
  ...
  const findCountryByPhoneNumber = (phoneNumber) => {
        ...
        <div className="bg-background rounded-md m-1 mt-0 border border-input p-5 space-y-5 h-full">
            ...
            <div className="basis-2/3">
              <div className="flex items-center gap-2.5">
                <div className="w-[60px] h-[60px] border border-border/50 rounded-lg flex items-center justify-center">
                  <img
                    src={
                      selectedImage || toAbsoluteUrl('/media/avatars/300-1.png')
                    }
                    alt="Profile"
          ...
          <div className="flex items-center gap-5">
            <div className="flex flex-col gap-0.5 basis-1/3">
              ...
              <span className="text-xs font-normal text-muted-foreground">
                Tags describing store products
              </span>
            </div>
            <Input
