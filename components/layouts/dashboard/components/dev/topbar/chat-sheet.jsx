...
import { AvatarGroup } from '@/components/layouts/dashboard/components/dev/common/avatar-group';
  ...
  const messages = [
    {
      ...
      time: '14:04',
      text: 'Hello! <br> today we are closing the query. Do You have update?',
      in: true,
    },
    {
    ...
    },
    {
      ...
      time: '14:26',
      text: 'I have checked the quotes, can not wait to respond them!',
      in: true,
    },
    {
      avatar: '/media/avatars/300-1.png',
      time: '15:09',
      text: 'I have looked over the tour plan, and everything seems spot on. I am ready on my end and can not wait for the user feedback.',
      in: true,
    },
    {
      avatar: '/media/avatars/300-2.png',
