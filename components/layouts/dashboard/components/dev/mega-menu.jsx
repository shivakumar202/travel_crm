...
import { MegaMenuSubAccount } from '@/components/layouts/dashboard/components/dev/mega-menu/mega-menu-sub-account';
import { MegaMenuSubAuth } from '@/components/layouts/dashboard/components/dev/mega-menu/mega-menu-sub-auth';
import { MegaMenuSubNetwork } from '@/components/layouts/dashboard/components/dev/mega-menu/mega-menu-sub-network';
import { MegaMenuSubProfiles } from '@/components/layouts/dashboard/components/dev/mega-menu/mega-menu-sub-profiles';
import { MegaMenuSubTrips } from '@/components/layouts/dashboard/components/dev/mega-menu/mega-menu-sub-trips';
import { MegaMenuSubStore } from '@/components/layouts/dashboard/components/dev/mega-menu/mega-menu-sub-store';
      ...
      <NavigationMenuList className="gap-2">
        ...
        <NavigationMenuItem>
          ...
          <NavigationMenuContent className="p-0">
            {/* Render Trips as single-column when this menu opens */}
            <MegaMenuSubTrips item={publicProfilesItem} />
          </NavigationMenuContent>
        </NavigationMenuItem>
        ...
        <NavigationMenuItem>
          <NavigationMenuTrigger
            className={cn(linkClass)}
            data-active={hasActiveChild(myAccountItem) || undefined}
          >
            {myAccountItem.title}
          </NavigationMenuTrigger>
          <NavigationMenuContent className="p-0">
            <MegaMenuSubTrips item={myAccountItem} />
          </NavigationMenuContent>
        </NavigationMenuItem>
        ...
        <NavigationMenuItem>
          ...
          <NavigationMenuContent className="p-0">
            <MegaMenuSubTrips item={networkItem} />
          </NavigationMenuContent>
        </NavigationMenuItem>
        ...
        <NavigationMenuItem>
          ...
          <NavigationMenuContent className="p-0">
            <MegaMenuSubTrips item={storeItem} />
          </NavigationMenuContent>
        </NavigationMenuItem>
        ...
        <NavigationMenuItem>
          ...
          <NavigationMenuContent className="p-0">
            <MegaMenuSubTrips item={authItem} />
          </NavigationMenuContent>
        </NavigationMenuItem>
      </NavigationMenuList>
    </NavigationMenu>
